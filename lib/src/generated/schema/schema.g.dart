...
_$UnionOutJobImpl _$$UnionOutJobImplFromJson(Map<String, dynamic> json) =>
    _$UnionOutJobImpl(
      id: json['id'] as String,
      autoStart: json['auto_start'] as bool,
      hyperparameters: TrainingParameters.fromJson(
      ...
      metadata: json['metadata'] == null
          ? null
          : JobMetadataOut.fromJson(json['metadata'] as Map<String, dynamic>),
      $type: json['UnionOut'] as String?,
    );

Map<String, dynamic> _$$UnionOutJobImplToJson(_$UnionOutJobImpl instance) {
  final val = <String, dynamic>{
    'id': instance.id,
    'auto_start': instance.autoStart,
    'hyperparameters': instance.hyperparameters,
  ...
  val['repositories'] = instance.repositories;
  writeNotNull('metadata', instance.metadata);
  val['UnionOut'] = instance.$type;
  return val;
}

_$UnionOutLegacyJobMetadataImpl _$$UnionOutLegacyJobMetadataImplFromJson(
        Map<String, dynamic> json) =>
    _$UnionOutLegacyJobMetadataImpl(
      expectedDurationSeconds:
          (json['expected_duration_seconds'] as num?)?.toInt(),
      cost: (json['cost'] as num?)?.toDouble(),
      costCurrency: json['cost_currency'] as String?,
...
Map<String, dynamic> _$$UnionOutLegacyJobMetadataImplToJson(
    _$UnionOutLegacyJobMetadataImpl instance) {
  final val = <String, dynamic>{};
