...
/// Union class for [JobOut], [LegacyJobMetadataOut]
@Freezed(unionKey: 'UnionOut')
sealed class UnionOut with _$UnionOut {
  const UnionOut._();
  ...
  /// Union constructor for [JobOut]
  const factory UnionOut.Job({
    /// The ID of the job.
    required String id,
  ...
  /// Union constructor for [LegacyJobMetadataOut]
  const factory UnionOut.LegacyJobMetadata({
    /// The approximated time (in seconds) for the fine-tuning process to complete.
    @JsonKey(name: 'expected_duration_seconds', includeIfNull: false)
    int? expectedDurationSeconds,
    ...
    @Default(LegacyJobMetadataOutObject.jobMetadata)
    LegacyJobMetadataOutObject object,
  }) = UnionOutLegacyJobMetadata;

  /// Object construction from a JSON representation
  factory UnionOut.fromJson(Map<String, dynamic> json) =>
      _$UnionOutFromJson(json);
}
